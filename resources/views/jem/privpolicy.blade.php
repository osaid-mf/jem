			...
			<div class="row">
                  ...
                  <div>
                    <div class="col-md-12">
                         ...
                         <p class="ab-p">
                           This Privacy Policy of www.immuniguard.com ("Company") covers the collection, use and disclosure of personal information that may be collected by the Company anytime you interact with the Company, such as visit our website, purchase products or services, or contact the Company. Your privacy is a priority of the Company and we go to great lengths to protect it.
                         </p>

                         <p class="ab-p">
                           You acknowledge that this Privacy Policy is part of our Terms of Service, and by accessing or using our site or purchase any of the offers associated with, you agree to be bound by all of its terms and conditions. This Privacy Policy covers the collection, use, and disclosure of personal information that may be collected. Please read the following carefully to learn how we collect information, or information practices including what type of information is gathered, how that information is used, to whom we disclose the information, and how we safeguard your personal information. If you do not agree to these terms, please do not access or use this site.
                         </p>

                         <p class="ab-p">
                           We reserve the right to change this Privacy Policy at any time. Any such changes, modifications, additions or deletions shall be effective immediately. You acknowledge and agree that it is your responsibility to review this site and this Policy periodically and to be aware of any modifications. Your continued use of the site after such modifications will constitute your acknowledgement of the modified Policy, and agreement to abide and be bound by the modified Policy.
                         </p>

                         <br><h6>TYPES OF INFORMATION COLLECTED</h6><br>

                         <p class="ab-p">
                           In order to better provide you with our numerous services, we collect two types of information about our users: Personally Identifiable Information and Non-Personally Identifiable Information. Our primary goal in collecting information from you is to provide you with a smooth, efficient, and customized experience while using our site and purchasing our offers.
                         </p>

                         <p class="ab-p">
                           Personally Identifiable Information: This refers to information that lets us know the specifics of who you are. When you engage in certain activities on this site, such as, ordering a product or service, submitting content and/or posting content in discussion forums or other public areas, or sending us feedback, we may ask you to provide certain information about If you yourself by filling out and submitting an online form. It is completely optional for you to engage in these activities. If you elect to engage in these activities, however, we may ask that you provide us personal information, such as your first and last name, mailing address (including zip code), email address, and other personal identifying information. When ordering products or services on the site, you may be asked to provide a credit card number. Depending upon the activity, some of the information we ask you to provide is identified as mandatory and some as voluntary. If you do not provide the mandatory data with respect to a particular activity, you will not be able to engage in that activity.
                         </p>
                         ...
                         <br><h6>COLLECTION METHOD AND USE OF INFORMATION</h6><br>

                         <p class="ab-p">
                          We do not collect any Personally Identifiable Information about you unless you voluntarily provide it to us. You provide certain Personally Identifiable Information to us when you: register for our services and register your email address with us; sign up for special offers from selected third parties; send email messages, submit forms or transmit other information by telephone or letter; or submit your credit card or other payment information when ordering and purchasing products and services on our site. We may also collect information from you at other points on our site that state that such information is being collected.
                         </p>
                         ...
                         <br><h6>RELEASE OF INFORMATION</h6><br>

                         <p class="ab-p">
                           Disclosure of Information to Service Providers and Third Party Vendors. immuniguard.com may disclose your Personally Identifiable Information to third party service providers and vendors in order to effect or carry out any transaction that you have requested from immuniguard.com or as necessary to complete its contractual obligations with you. This includes e-mail service providers, providers of direct marketing services and applications, including lookup and reference, and data enhancement, suppression and validation services.
                         </p>

                         <p class="ab-p">
                           immuniguard.com contractually prohibits the sale or transfer of Personally Identifiable Information by such service providers and vendors. immuniguard.com may share Personally Identifiable Information with affiliated companies that are directly or indirectly controlled by, or under common control of immuniguard.com.
                         </p>
                         ...
                         <br><h6>PRIVACY POLICIES OF THIRD PARTY SITES</h6><br>

                         <p class="ab-p">
                         This document only addresses the use and disclosure of information we collect from you. Other sites accessible through our site have their own privacy policies and data collection, use and disclosure practice. We are not responsible for the policies or practices of third parties. Additionally other companies which place advertising on our site may collect information about you when you view or click on their advertising through their use of cookies. We cannot control this collection of information. You should contact these advertisers directly if you have any questions about their use of the information they collect.
                         </p>
